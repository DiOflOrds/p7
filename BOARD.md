...
|---|---|---|---|---|---|---|
| [T-0001](tickets/T-0001.md) | MAN.3: Sprint-0-Planning + Auftrag aus pm/T-0005 (P7b) überführen | task | pl | hoch | 0 | — |
| [T-0002](tickets/T-0002.md) | SWE.1: STK-017 + SWR-053–058 (Teams im HMI) draft → reviewed | task | rm | hoch | 0 | — |
| [T-0003](tickets/T-0003.md) | DR: G1 — Anforderungs-Erweiterung Teams im HMI (STK-017, SWR-053–058) freigeben | decision-request | pl | hoch | 0 | — |
| [T-0004](tickets/T-0004.md) | MAN.3: Sprint-1-Planning — Team-Ansicht + Konfigurator | task | pl | hoch | 1 | — |
| [T-0005](tickets/T-0005.md) | BCK: teams.py + /api/team* mit PIN-Lesegate (SWR-053) + ADR-006-Delta | task | dev | hoch | 1 | — |
